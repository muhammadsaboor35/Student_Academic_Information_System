...
if(isset($_GET['List_Student_Button'])) {
    $_SESSION['ListStudent_Button'] = $_GET['List_Student_Button'];
    header("Location: List_Student.php" );
}

if(isset($_GET['List_Task_Button'])) {
  $_SESSION['ListTask_Button'] = $_GET['List_Task_Button'];
      ...
      <table class="table table-hover justify-content-center text-center">
        ...
        <tbody>
           ...
           <?php for($i = 0; $i < count($depts); $i++) { ?>
            ...
            <form>
            <td><button type="submit" value="<?php echo $course_IDs[$i]; ?>" name= "List_Student_Button" class="btn btn-primary btn-sm">List Students</button></td>
            </form>

            <form>
            <td><button type="submit" value="<?php echo $course_IDs[$i]; ?>" name= "List_Task_Button" class="btn btn-primary btn-sm">Tasks</button></td>
            </form>
