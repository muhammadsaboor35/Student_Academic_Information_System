...
try {
  ...
  $sql = "SELECT person_ID, first_name, last_name, email FROM (Person P, Student_Sections S) WHERE S.course_ID = :c_ID AND S.student_ID = P.person_ID";
  ...
  foreach($result as $temp) {
    ...
    array_push($email_address, $temp[3]);
    ...
    <nav class="navbar sticky-top justify-content-center navbar-expand-lg navbar-dark bg-primary pt-2 pb-2 mx-auto" style="width: 50%;">
      <ul class="nav justify-content-center nav-pills ">
        ...
        <li class="nav-item pr-3">
          <a class="nav-link" href="Email.php">Back</a>
        </li>
      ...
      <table class="table table-hover justify-content-center text-center">
        ...
        <tbody>
           ...
           <?php for($i = 0; $i < count($student_IDs); $i++) { ?>
            ...
            <td><?php  echo $email_address[$i] ?></td>
          </tr>
           <?php } ?>
        </tbody>
      </table>
