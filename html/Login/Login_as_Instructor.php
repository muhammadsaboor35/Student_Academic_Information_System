...
if (isset($_POST['login'])) {
  try {
    ...
    $sql = "SELECT person_ID FROM Person NATURAL JOIN Instructor
	WHERE person_ID = :id
	...
	header("Location: http://localhost/html/Instructor/inst_Home.php");
	exit();
    }
    else {
  ...
  <body>
	...
	<li class="nav-item pr-3">
	  <div class="col-sm-12 my-auto">Login As: </div>
        ...
        <li class="nav-item pr-3">
          <a class="nav-link active" href="Login_as_Instructor.php">Instructor</a>
        </li>
	<li class="nav-item pr-3">
	    ...
	    <div class="form-group custom-container2 container">
	      ...
	      <input type="password" class="form-control" name="password" placeholder="Enter password">
            ...
            <div>
              ...
              <a class="btn btn-link" href="Signup_as_Instructor.php" role="button">New user? Signup First!</a>
            </div>
	  </fieldset>
	</form>
      </div>
