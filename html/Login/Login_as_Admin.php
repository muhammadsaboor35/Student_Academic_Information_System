...
if (isset($_POST['login'])) {
  try {
	...
	header("Location: http://localhost/html/Admin/Clubs.php");
	exit();
    }
    else {
...
<html lang="en">
  ...
  <body>
	...
	<li class="nav-item pr-3">
	  <a class="nav-link active" href="Login_as_Admin.php">Admin</a>
	</li
      </ul>
    </nav>
	    ...
	    <div class="form-group custom-container2 container">
	      ...
	      <input type="password" class="form-control" name="password" placeholder="Enter password">
            ...
            <div>
              ...
              <a class="btn btn-link" href="Signup_as_Admin.php" role="button">New user? Signup First!</a>
            </div>
	  </fieldset>
	</form>
      </div>
