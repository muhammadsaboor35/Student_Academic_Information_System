...
if(isset($_GET['search'])) {
  ...
  $result = file_get_contents("Seminars.php", false, $context);
}
else {
if(isset($_GET['join'])) {
	$name = $_GET['name_var'];
...
if(isset($_GET['details'])) {
	...
	$date = $_GET['date'];
	$host_ID = $_GET['host_ID'];
	header("Location: http://localhost/html/Student/Details_Seminar.php?name=".$name_var."&date=".$date."&host_ID=".$host_ID);
	exit();
}
    ...
    <div class="container">
      <table class="table table-hover justify-content-center text-center">
	   ...
	   <?php for($i = 0; $i < count($names); $i++) { ?>
		...
		<td><button type="button" class="btn btn-primary btn-sm"><a href="Seminars.php?details=true&name_var=<?php echo $names[$i] ?>&date=<?php echo $dates[$i] ?>&host_ID=<?php echo $host_IDs[$i] ?>" class="nav-link">Details</a></button></td>
		...
		<?php } else { ?>
		<td><button type="button" class="btn btn-primary btn-sm"><a href="Seminars.php?join=true&name_var=<?php echo $names[$i] ?>&date=<?php echo $dates[$i] ?>&host_ID=<?php echo $host_IDs[$i] ?>" class="nav-link">Join</a></button></td>
		<?php } ?>
		</tr>
	   <?php } ?>
        </tbody>
